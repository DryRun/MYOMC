...
djrTable = cms.EDProducer("SimpleCandidateFlatTableProducer", 
    src       = cms.InputTag("generator"),
    cut       = cms.string(""), 
    name      = cms.string("Generator2"),
    doc       = cms.string("Generator information 2"),
    singleton = cms.bool(False), 
    extension = cms.bool(False),
    variables = cms.PSet(
        djrValues = Var("?hasDJRValues()?DJRValues():-1", float, doc="DJR values", precision=14),
    ),
)
